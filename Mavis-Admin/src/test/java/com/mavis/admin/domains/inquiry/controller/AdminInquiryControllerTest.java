...
class AdminInquiryControllerTest extends ControllerTestSupport {
    ...
    @Test
    void 문의_목록_조회_성공() throws Exception {
    ...
    @Test
    void 문의_상세_조회_성공() throws Exception {
    ...
    @Test
    void 문의_상세_조회_답변_포함() throws Exception {
        Inquiry inquiry = inquiryRepository.save(Inquiry.builder()
                .question("답변있는 질문")
                .isPrivate(false)
                .product(savedProduct)
    ...
    @Test
    void 존재하지_않는_문의_상세_조회시_404() throws Exception {
    ...
    @Test
    void 문의_답변_등록_성공() throws Exception {
        Inquiry inquiry = inquiryRepository.save(Inquiry.builder()
                .question("질문")
                .isPrivate(false)
                .product(savedProduct)
    ...
    @Test
    void 문의_답변_수정_성공() throws Exception {
        Inquiry inquiry = inquiryRepository.save(Inquiry.builder()
                .question("질문")
                .isPrivate(false)
                .product(savedProduct)
    ...
    @Test
    void 문의_답변_삭제_성공() throws Exception {
        Inquiry inquiry = inquiryRepository.save(Inquiry.builder()
                .question("질문")
                .isPrivate(false)
                .product(savedProduct)
