...
public enum GlobalErrorCode implements BaseErrorCode {
    ...
    TOKEN_EXPIRED(401, "AUTH_401_1", "인증 시간이 만료되었습니다. 인증토큰을 재 발급 해주세요"),
    REFRESH_TOKEN_EXPIRED(403, "AUTH_403_1", "인증 시간이 만료되었습니다. 재 로그인 해주세요."),
    INVALID_TOKEN(401, "GLOBAL_401_1", "잘못된 토큰입니다. 재 로그인 해주세요"),
